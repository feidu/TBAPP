...
{
    public partial class Item_AutoRelist : BasePage
    {
        string pageCode = "AutoRelist";
        ...
        {
            bool state = switchAction.GetSwitchState(base.nick, Util.Enum.AutoSwitchType.AutoRelist.ToString());
        ...
        {
            switchAction.ChangSwitchState(base.nick, Util.Enum.AutoSwitchType.AutoRelist.ToString(), !oldstate);
            return !oldstate;
        }
    }
}