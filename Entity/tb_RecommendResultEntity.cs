...
namespace Entity
{
    ...
    [Serializable()]
    public class tb_RecommendResultEntity : EntityObject
    {
        ...
        public tb_RecommendResultEntity()
        {
        }
    ...
    /// tb_RecommendResultEntity执行类
    public abstract class tb_RecommendResultEntityAction
    {
        
        private tb_RecommendResultEntityAction()
        {
        }
