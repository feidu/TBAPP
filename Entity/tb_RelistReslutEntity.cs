...
namespace Entity
{
    ...
    [Serializable()]
    public class tb_RelistReslutEntity : EntityObject
    {
    ...
    /// tb_RelistReslutEntity执行类
    public abstract class tb_RelistReslutEntityAction
    {
        
        private tb_RelistReslutEntityAction()
        {
        }
        
        public static void Save(tb_RelistReslutEntity obj)
        {
            if (obj!=null)
            {
                obj.Save();
        ...
        public static tb_RelistReslutEntity RetrieveAtb_RelistReslutEntity(int id)
        {
            tb_RelistReslutEntity obj=new tb_RelistReslutEntity();
            obj.id=id;
            obj.Retrieve();
            if (obj.IsPersistent)
            {
