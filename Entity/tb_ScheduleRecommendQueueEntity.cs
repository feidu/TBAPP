...
//             Created By： John
//             Created Time： 2012/7/25 14:43:39
// 
// -------------------------------------------------------------
namespace Entity
{
    ...
    [Serializable()]
    public class tb_ScheduleRecommendQueueEntity : EntityObject
    {
        ...
        public tb_ScheduleRecommendQueueEntity()
        {
        }
    ...
    /// tb_ScheduleRecommendQueueEntity执行类
    public abstract class tb_ScheduleRecommendQueueEntityAction
    {
        
        private tb_ScheduleRecommendQueueEntityAction()
        {
        }
